...
describe('API', () => {
    ...
    describe('/node', () => {
        ...
        describe('DELETE', () => {
            ...
            test('should delete a node with and id that isn\'t root', async (done) => {
                ...
                try {
                    ...
                    expect(res.status).toBe(200);
                    expect(res.body.description).toBe(description_1);
                    expect(res.body._id).toBe(id_1);
            ...
            test('should fail when deleting a root node', async (done) => {
                ...
                try {
                    ...
                    expect(res.status).toBe(400);
                    expect(res.body.error).toBe('Illegal action!');
                    expect(res.body.message).toBe('Can\'t delete root node, make another node root first');
